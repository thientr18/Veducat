...
// Annoucement
router.get('/announcement/send_to_all', requireAuthZ('admin'), checkUser, adminController.admin_send_to_all_get);
...
router.get('/announcement/send_to_teacher', requireAuthZ('admin'), checkUser, adminController.admin_send_to_teacher_get);
...
router.get('/announcement/send_to_student', requireAuthZ('admin'), checkUser, adminController.admin_send_to_student_get);
